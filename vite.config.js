  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        shortcuts: [
          { name: 'Dashboard', short_name: 'Dashboard', description: 'Open your NexaSphere dashboard', url: '/dashboard', icons: [{ src: '/pwa-192x192.png', sizes: '192x192' }] },
          { name: 'View Events', short_name: 'Events', description: 'Browse upcoming events', url: '/events', icons: [{ src: '/pwa-192x192.png', sizes: '192x192' }] }
        ],
